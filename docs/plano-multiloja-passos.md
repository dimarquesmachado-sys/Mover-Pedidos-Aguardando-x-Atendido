...
| 2.5 | `mlApi.js` | 119 | 88% | 81% | ⬜ LIBERADO — diff é só rótulo de log e exports (Girassol expõe `getShipmentRaw` de debug); não usa `enviarNFeParaLojaVirtual`, não depende do 2.4 |
