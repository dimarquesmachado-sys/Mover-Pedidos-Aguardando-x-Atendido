...
function criar(cfg) {
  ...
  try {
    ...
    /* 23/09 (Codex #514, P2): a FOTO tinha o mesmo problema do `kit` logo acima — abrir um
       produto pela busca regravava a entrada sem ela, e a imagem que a indexação completa
       tinha guardado sumia. Efeito na tela: o resultado aparecia com foto, o funcionário
       clicava, e da próxima busca o mesmo produto vinha sem.
       `primeiraImagem` lê o mesmo campo do detalhe que o indexador lê; se o detalhe não
       trouxer, PRESERVA o que já estava no índice em vez de apagar. */
    const imgAntes = (() => {
