        ...
        try {
          ...
          if (temComponentes || fmt === 'E') {
            ...
            return {
              ...
              componentes: comps.slice(0, 12).map(c => ({
                sku: (c.produto && c.produto.codigo) || c.codigo || '',
                nome: (c.produto && c.produto.nome) || c.nome || '',
                qtd: Number(c.quantidade || c.qtd || 1) || 1,
              })).filter(c => c.sku || c.nome),
            };
          }
          if (fmt === 'V') {
