...
function criar(cfg) {
  ...
  function _sugerirEnvs(prefixo, situacoes, canais, canalMlProvado) {
    ...
    if (canalMlProvado) {
      ...
      /* o `obs` já começa com "PROVADO:", então prefixar de novo gerava "PROVADO — PROVADO:"
         na linha que o dono lê. Detalhe pequeno, mas é a frase que decide se ele confia. */
