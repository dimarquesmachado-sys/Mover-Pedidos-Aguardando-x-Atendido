/* 02/09 — MOVIDO DE 3 CÓPIAS PRA CÁ (dívida dos checkouts, doc de paridade).
   Conferido antes: as três cópias (girassol/good/amb) eram IDÊNTICAS byte a byte, e este
   arquivo não usa nada do escopo da empresa — só os próprios parâmetros. Os módulos das
   empresas passam a re-exportar daqui, então quem chama não muda nada. */
