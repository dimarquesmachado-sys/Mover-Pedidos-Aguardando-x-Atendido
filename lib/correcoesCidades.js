...
const CORRECOES_CIDADE = {
  ...
  'caiçara|ce':                 { municipio: 'Cruz', uf: 'CE' },
  'caicara|ce':                 { municipio: 'Cruz', uf: 'CE' },
  // Nomes que clientes informam sem o hífen oficial:
  'embu guaçu|sp':              { municipio: 'Embu-Guaçu', uf: 'SP' },
  'embu guacu|sp':              { municipio: 'Embu-Guaçu', uf: 'SP' },
  'embu-guacu|sp':              { municipio: 'Embu-Guaçu', uf: 'SP' },
};
...
const FALLBACK_POR_CEP = {
  ...
  '62597000': { municipio: 'Cruz', uf: 'CE' },          // Caiçara (distrito)
};
