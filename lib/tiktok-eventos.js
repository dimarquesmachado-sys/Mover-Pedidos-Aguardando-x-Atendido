...
const RX_REVELIA = /TIMEOUT/i;              // SELLER_REJECT_RECEIVE_DELIVERED_TIMEOUT
...
function resumirEventos(records) {
  ...
  const r = { eventos: lista.length, abriu_em: null, aprovado_em: null, postado_em: null,
              reembolsado_em: null, revelia_em: null, entregue_indicado: false, ultimo: null };
  ...
  /* dias entre postar e a revelia — nos 2 casos reais deu 6 e 7; é o relógio do prazo */
