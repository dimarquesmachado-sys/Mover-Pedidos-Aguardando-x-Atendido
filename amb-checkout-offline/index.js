...
const VERSAO     = 'amb-checkout-offline v10/08 b30';
  ...
  try {
    ...
    for (let pg = 1; pg <= 20; pg++) {
      ...
      for (const p of lista) {
        ...
        // b30: o Bling FINALMENTE importou este pedido? A entrada provisória que veio
        // DIRETO do ML (chave 'ml:<order_id>') cede o lugar — sem duplicata na tela.
        if (nl) delete atual['ml:' + String(nl)];
      }
      if (lista.length < 100) break;
