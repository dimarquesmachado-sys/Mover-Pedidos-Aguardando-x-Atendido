...
const VERSAO     = 'amb-checkout-offline v14/08 b71';
  ...
  try {
    ...
    for(let pg=1; pg<=500; pg++){
      ...
      for(const p of lista){
        ...
        const ufPed = String((det.transporte && det.transporte.etiqueta && det.transporte.etiqueta.uf) || '').trim().toUpperCase().slice(0, 2) || null;
