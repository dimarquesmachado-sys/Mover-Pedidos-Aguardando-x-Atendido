...
/* 14/09 — FACHADA (passo 1 da Fase 3). Este arquivo era ESPELHADO nas três pastas, com
   ...
   vezes. A regra agora vive em lib/checkout/produtos.js; aqui fica só a tag DESTA empresa, que é o
   que identifica a linha no log do serviço. */

module.exports = require('../lib/checkout/produtos').criar({ tag: 'GOODBKP', base: require('./base') });
