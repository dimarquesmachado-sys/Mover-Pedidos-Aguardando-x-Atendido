...
module.exports = criarNfBlingApi({
  ...
  envPausa: 'NF_PAUSA_MS',
  envIntermediadorCnpj: 'NF_INTERMEDIADOR_CNPJ',
  envIntermediadorNome: 'NF_INTERMEDIADOR_NOME',
  intermediadorCnpj: '03007331000141',
  intermediadorNome: 'MAGAZINEGIRASSOL',
