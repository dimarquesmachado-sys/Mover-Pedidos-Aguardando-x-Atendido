...
const VERSAO     = 'girassol-backup-offline v02/08 b91';
...
function routes(readBody) {
  ...
  if (!body.fresh && c && c.nome !== undefined && (Date.now() - (c.ts || 0)) < TTL && (c.custo != null || c.saldo != null)) {
    ...
    if (method === 'GET' && p === '/girassol-backup-offline/ml-billing-status') {
      ...
      json(res, 200, { ok: true, status: _mlb, tentativas: _mlb.tentativas || [], detalhes: _mlb.detalhes || [], amostra_periodos: _mlb.amostra_periodos || null, atualizado: b.atualizado || null,
