...
const VERSAO     = 'girassol-backup-offline v31/07 b73';
...
function routes(readBody) {
  ...
  if (!body.fresh && c && c.nome !== undefined && (Date.now() - (c.ts || 0)) < TTL && (c.custo != null || c.saldo != null)) {
    ...
    if (method === 'GET' && p === '/girassol-backup-offline/historico-longo') {
      ...
      const pedImposto = {}, semImpMeses = new Set();
      ...
      try {
        while (offset < 60000) {
          ...
          for (const l of linhas) {
            ...
            { const kp = String(l.numero_pedido || l.numero_loja || ''); if (kp) { pedImposto[kp] = (pedImposto[kp] || 0) + im; } }
