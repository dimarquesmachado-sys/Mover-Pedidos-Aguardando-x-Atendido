...
const VERSAO     = 'girassol-backup-offline v02/08 b97';
    ...
    if (method === 'GET' && p === '/girassol-backup-offline/ml-vendas-faltando') {
      ...
      for (const t of Object.values(b.tarifas || {})) {
        ...
        { const at = doML.get(String(t.o)) || { com: 0, pack: null };
          doML.set(String(t.o), { com: Math.round((at.com + t.v) * 100) / 100, pack: t.p || at.pack || null }); }
      }
      ...
      json(res, 200, { ok: true, de: deF, ate: ateF,
        vendas_no_ml: doML.size, vendas_no_nosso_historico: nosso.size, faltando: faltam.length, achadas_pelo_carrinho: achadasPeloPack,
