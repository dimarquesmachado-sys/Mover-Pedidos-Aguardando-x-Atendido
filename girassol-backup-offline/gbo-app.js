...
function bootstrap() {
  ...
  /* 09/09 (pedido do Diego): re-busca COMPLETA do custo TODO DIA às 23h15 — mudança de
  ...
  setInterval(() => {
    try {
      ...
      if (ag.getHours() === 23 && ag.getMinutes() >= 15 && _custoDiarioDia !== dia) {
        _custoDiarioDia = dia;
        console.log('[custo-diario] re-busca completa das 23h15 iniciando');
