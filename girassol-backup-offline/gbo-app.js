...
const VERSAO     = 'girassol-backup-offline v09/08 b134';
            ...
            if (cEsc && cEsc.tarifa > 0) {
              ...
              try {
                if (ehFlex(servicoDoPedido(det))) {
                  ...
                  const _v = (_fx.shopee != null) ? Number(_fx.shopee) : ((_fx.geral != null) ? Number(_fx.geral) : 0);
                  if (isFinite(_v) && _v > 0) _motoboy = _v;
                }
              } catch (e) {}
              freteShopee = Math.max(0, Math.round((_motoboy + _liqSh) * 100) / 100);
              if (_backfill.shopee) {
