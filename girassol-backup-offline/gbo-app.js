...
const VERSAO     = 'girassol-backup-offline v06/08 b121';
...
const { rotasShopee, escrowDoPedido, contasDoEscrow } = require('./gbo-shopee');
      ...
      for(const p of lista){
        ...
        if (canal === 'shopee' && nl && (SHOPEE_TODOS || !comissao || comissao <= 0)) {
          try {
            ...
            const cEsc = (rEsc && rEsc.ok && rEsc.dados) ? contasDoEscrow(rEsc.dados.resposta) : null;
          ...
          if (jS && jS.ok && Array.isArray(jS.pedidos)) {
            ...
            for (const v of candS) {
              ...
              if (es && (v.tarifa_ml == null || !v.tarifa_shopee_v2)) {
                ...
                const tS = Math.round((com + srv + rbt + afi + cam + prc) * 100) / 100;
