...
const VERSAO     = 'girassol-backup-offline v06/08 b126';
...
// ════════════════════════════════════════════════════════════════════════
let _varFor = { rodando: false, fase: 'parado', vistos: 0, sem_fornecedor: 0, divergentes: 0, erros: 0, inicio: null, fim: null, lista: [] };
  ...
  try {
    for (let pag = 1; pag <= 60 && _varFor.vistos < teto; pag++) {
      ...
      for (const p0 of lista) {
        ...
        if (!f || !f.codigo) { _varFor.sem_fornecedor++; continue; }
