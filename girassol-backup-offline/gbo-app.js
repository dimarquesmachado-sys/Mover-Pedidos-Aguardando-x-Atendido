...
const VERSAO     = 'girassol-backup-offline v06/08 b119';
...
async function backfillVendas(de, ate, empresa){
  ...
  try {
    ...
    _backfill.shopee = { escrow_fechou: 0, escrow_com_sobra: 0, escrow_sem_resposta: 0, escrow_erro: 0, modo: SHOPEE_TODOS ? 'todos os pedidos' : 'so quando o Bling nao trouxe taxa' };
        ...
        if (canal === 'shopee' && nl && (SHOPEE_TODOS || !comissao || comissao <= 0)) {
          try {
            ...
            if (cEsc && cEsc.tarifa > 0) {
              ...
              // o LIQUIDO das duas pontas (o comprador pagou X, o frete custou Y).
              // Positivo = saiu do bolso; negativo = sobrou dinheiro de frete pra loja.
              freteShopee = cEsc.frete_liquido_vendedor;
