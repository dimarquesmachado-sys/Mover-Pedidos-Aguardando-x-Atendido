...
const VERSAO     = 'girassol-backup-offline v06/08 b124';
    ...
    if (method === 'GET' && p === '/girassol-backup-offline/produto-cru') {
      ...
      try {
        ...
        json(res, 200, {
          ...
          resposta_crua: d ? JSON.stringify(d).slice(0, 6000) : null,
          leia: 'se "tem_fornecedores" vier true, dá pra varrer o catálogo inteiro e achar todo SKU cujo código no fornecedor não bate com o próprio SKU.'
        });
